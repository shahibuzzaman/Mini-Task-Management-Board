    ...
    <>
      ...
      <div className="flex items-center justify-between p-6 lg:block">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-[17px] font-bold text-slate-900 tracking-tight leading-tight">TaskTrack</h1>
            <p className="mt-0.5 text-[9px] font-bold uppercase tracking-[0.15em] text-slate-500">Task Tracking Workspace</p>
          </div>
        </div>
        <button
          type="button"
