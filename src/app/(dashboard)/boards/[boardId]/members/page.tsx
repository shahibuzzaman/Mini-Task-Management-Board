...
import { BoardMembersPage as BoardMembersTabPage } from "@/components/board/board-members-page";
...
export default async function BoardMembersPage({
  ...
  if (redirectBoardId && redirectBoardId !== boardId) {
    redirect(getBoardSectionPath(redirectBoardId, "members"));
  }
  ...
  return <BoardMembersTabPage board={board} viewer={viewer} />;
}
